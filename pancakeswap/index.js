...
/* gerado em: https://api.pancakeswap.info/api/v2/tokens/ */
...
setInterval(async () => {
  const { data } = await axios.get(
    "https://api.pancakeswap.info/api/v2/tokens/" + CAKE_MAINNET
  );
  /* console.log(data);
  ...
  if (price < 4 && !isOpened) {
    ...
    swapTokens(USDT_TESTNET, "10", CAKE_TESTNET); // 10DOLARES
    isOpened = true;
